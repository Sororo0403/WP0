...
$textInspectorLizardReport =
    Join-Path $reportDirectory "lizard-editor-inspector-text-final.txt"
& lizard "editor/src/EditorSceneInspectorText.cpp" -l cpp -t 1 -C 12 -L 36 -w -i 0 `
    -o $textInspectorLizardReport
if ($LASTEXITCODE -ne 0) {
    throw "EditorScene Text Inspector exceeded its refactored complexity ceiling."
}

$transformInspectorLizardReport =
    Join-Path $reportDirectory "lizard-editor-inspector-transform-final.txt"
& lizard "editor/src/EditorSceneInspectorTransform.cpp" -l cpp -t 1 -C 14 -L 44 -w -i 0 `
...
$dropdownInspectorLizardReport =
    Join-Path $reportDirectory "lizard-editor-inspector-dropdown-final.txt"
& lizard "editor/src/EditorSceneInspectorDropdown.cpp" -l cpp -t 1 -C 5 -L 22 -w -i 0 `
    -o $dropdownInspectorLizardReport
if ($LASTEXITCODE -ne 0) {
    throw "EditorScene Dropdown Inspector exceeded its refactored complexity ceiling."
}
...
$physicsGizmoLizardReport =
    Join-Path $reportDirectory "lizard-editor-physics-gizmos-final.txt"
& lizard "editor/src/EditorScenePhysicsGizmos.cpp" -l cpp -t 1 -C 8 -L 24 -w -i 0 `
    -o $physicsGizmoLizardReport
if ($LASTEXITCODE -ne 0) {
    throw "EditorScene Physics Gizmos exceeded their refactored complexity ceiling."
}

$componentGizmoLizardReport =
    Join-Path $reportDirectory "lizard-editor-component-gizmos-final.txt"
& lizard "editor/src/EditorSceneComponentGizmos.cpp" -l cpp -t 1 -C 13 -L 28 -w -i 0 `
    -o $componentGizmoLizardReport
if ($LASTEXITCODE -ne 0) {
    throw "EditorScene Component Gizmos exceeded their refactored complexity ceiling."
}

$hierarchyLizardReport =
    Join-Path $reportDirectory "lizard-editor-hierarchy-final.txt"
& lizard "editor/src/EditorSceneHierarchy.cpp" -l cpp -t 1 -C 27 -L 99 -w -i 0 `
    -o $hierarchyLizardReport
if ($LASTEXITCODE -ne 0) {
    throw "EditorScene Hierarchy exceeded its refactored complexity ceiling."
}

$hierarchyPanelLizardReport =
    Join-Path $reportDirectory "lizard-editor-hierarchy-panel-final.txt"
& lizard "editor/src/EditorSceneHierarchyPanel.cpp" -l cpp -t 1 -C 6 -L 27 -w -i 0 `
    -o $hierarchyPanelLizardReport
if ($LASTEXITCODE -ne 0) {
    throw "EditorScene Hierarchy Panel exceeded its refactored complexity ceiling."
}

$shortcutsLizardReport =
    Join-Path $reportDirectory "lizard-editor-shortcuts-final.txt"
& lizard "editor/src/EditorSceneShortcuts.cpp" -l cpp -t 1 -C 12 -L 25 -w -i 0 `
...
& lizard "editor/src/EditorSceneAssets.cpp" -l cpp -t 1 -C 31 -L 110 -w -i 0 `
    -o $assetsLizardReport
if ($LASTEXITCODE -ne 0) {
    throw "EditorScene Assets exceeded their refactored complexity ceiling."
}

$assetDetailsLizardReport =
    Join-Path $reportDirectory "lizard-editor-asset-details-final.txt"
& lizard "editor/src/EditorSceneAssetDetails.cpp" -l cpp -t 1 -C 8 -L 20 -w -i 0 `
    -o $assetDetailsLizardReport
if ($LASTEXITCODE -ne 0) {
    throw "EditorScene Asset Details exceeded its refactored complexity ceiling."
}
...
$runtimeAudioLizardReport =
    Join-Path $reportDirectory "lizard-editor-runtime-audio-final.txt"
& lizard "editor/src/EditorSceneRuntimeAudio.cpp" -l cpp -t 1 -C 19 -L 52 -w -i 0 `
    -o $runtimeAudioLizardReport
if ($LASTEXITCODE -ne 0) {
...
Write-Output "EditorScene Hierarchy Panel Lizard regressions: 0"
...
Write-Output "EditorScene Asset Details Lizard regressions: 0"
